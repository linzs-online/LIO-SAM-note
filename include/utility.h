...
public:
    ...
    Eigen::Matrix3d extRot;     // xyz坐标系旋转, body to lidar
    Eigen::Matrix3d extRPY;     // RPY欧拉角的变换关系, body to lidar
    ...
    */
    sensor_msgs::Imu imuConverter(const sensor_msgs::Imu& imu_in)
    {
        ...
        Eigen::Quaterniond q_final = q_from * extQRPY; // body->lidar->lidar姿态
